# Netflix OTT Data Analytics

## Project Overview
This project analyzes Netflix’s content catalog to uncover insights related to **content growth, genre distribution, and global content strategy**. The objective is to understand how Netflix balances **movies vs TV shows**, invests in **international content**, and diversifies its genres to support **user retention and expansion**.
...
- Identify **top genres** and evaluate content diversification  
...
- Normalized multi-genre fields to avoid double counting  
...
- Top 10 genres by unique titles  
...
- **TV shows dominate genre diversity**, supporting long-term user retention  
...
- Perform real-world data cleaning and exploratory analysis  
